...
import type * as ArgumentTypes from '../types-arguments/fooddelivery';
import type * as ReturnTypes from '../types-returns/fooddelivery';
import type BN from 'bn.js';
//@ts-ignore
import {ReturnNumber} from '@727-ventures/typechain-types';
import {getTypeDescription} from './../shared/utils';
import DATA_TYPE_DESCRIPTIONS from '../data/fooddelivery.json';
