    ...
    T: Storage<Data> + Storage<ownable::Data>,
{
    ...
    default fn submit_order(&mut self, food_id: FoodId, delivery_address: String) -> OrderResult {
        ...
        ensure!(price == self.data::<Data>().food_data.get(&food_id).unwrap().price.into(), FoodOrderError::NotSamePrice);
    ...
    default fn accept_delivery(
        ...
        self.emit_accept_delivery_event(
            order_id,
            delivery_id,
        );
        ...
        let delivery_status = DeliveryStatus::Accept;
    ...
    T: Storage<Data>,
{
    ...
    default fn emit_accept_delivery_event(
        &self, 
    ...
    E: From<FoodOrderError>,
{
        ...
        instance.data().customer_account_id.contains(&T::env().caller()),
