pub use crate::{
    ...
    impls::types::{CourierId, Data, DeliveryId, DeliveryStatus, FoodOrderError, OrderStatus},
    ...
    T: Storage<Data> + Storage<ownable::Data>,
{
    ...
    default fn pickup_delivery(&mut self, delivery_id: DeliveryId) -> DeliveryResult {
        let courier_account = T::env().caller();
            ...
            FoodOrderError::DeliveryStatusNotWaiting
        );
